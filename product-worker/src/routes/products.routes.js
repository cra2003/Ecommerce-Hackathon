import { createProductHandler, listAllProductsHandler, listProductsHandler, getProductHandler, updateProductHandler, deleteProductHandler } from '../handlers/products.handler.js'
